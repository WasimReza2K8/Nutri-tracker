...
class S {
  ...
  String get addMoreLabel {
    return Intl.message('Add more', name: 'addMoreLabel', desc: '', args: []);
  }
  ...
  String get kcalOverLabel {
    return Intl.message('kcal over', name: 'kcalOverLabel', desc: '', args: []);
  }
  ...
  String get searchModeLabel {
    return Intl.message('Search', name: 'searchModeLabel', desc: '', args: []);
  }

  /// `Camera`
  String get cameraModeLabel {
    return Intl.message('Camera', name: 'cameraModeLabel', desc: '', args: []);
  }

  /// `Barcode`
  String get barcodeModeLabel {
    return Intl.message(
      'Barcode',
      name: 'barcodeModeLabel',
      desc: '',
      args: [],
    );
  }
  ...
  String get manualModeLabel {
    return Intl.message('Manual', name: 'manualModeLabel', desc: '', args: []);
  }

  /// `Camera permission is required to scan food`
  String get cameraPermissionDeniedLabel {
    return Intl.message(
      'Camera permission is required to scan food',
      name: 'cameraPermissionDeniedLabel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Analyzing your food...`
  String get cameraAnalyzingLabel {
    return Intl.message(
      'Analyzing your food...',
      name: 'cameraAnalyzingLabel',
      desc: '',
      args: [],
    );
  }
  ...
  String get cameraErrorLabel {
    return Intl.message(
      'Failed to analyze image. Please try again.',
      name: 'cameraErrorLabel',
      desc: '',
      args: [],
    );
  }
  ...
  String get cameraTakePhotoLabel {
    return Intl.message(
      'Take a photo of your food',
      name: 'cameraTakePhotoLabel',
      desc: '',
      args: [],
    );
  }
