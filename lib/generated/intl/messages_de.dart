...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(rate) => "~${rate} pro Woche";

  static String m4(date) => "Zieldatum: ${date}";

  static String m5(weeks) => "${weeks} Wochen entfernt";

  static String m6(value) => "Ziel: ${value}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMoreLabel": MessageLookupByLibrary.simpleMessage("Mehr hinzufügen"),
    ...
    "appVersionName": m0,
    "barcodeModeLabel": MessageLookupByLibrary.simpleMessage("Barcode"),
    ...
    "bodyInfoLabel": MessageLookupByLibrary.simpleMessage("Körperdaten"),
    ...
    "cameraAnalyzingLabel": MessageLookupByLibrary.simpleMessage(
      "Essen wird analysiert...",
    ),
    "cameraErrorLabel": MessageLookupByLibrary.simpleMessage(
      "Bildanalyse fehlgeschlagen. Bitte versuchen Sie es erneut.",
    ),
    "cameraModeLabel": MessageLookupByLibrary.simpleMessage("Kamera"),
    "cameraPermissionDeniedLabel": MessageLookupByLibrary.simpleMessage(
      "Kameraberechtigung ist erforderlich, um Essen zu scannen",
    ),
    "cameraTakePhotoLabel": MessageLookupByLibrary.simpleMessage(
    ...
    "componentsLabel": MessageLookupByLibrary.simpleMessage("Bestandteile"),
    ...
    "kcalOverLabel": MessageLookupByLibrary.simpleMessage("kcal über"),
    ...
    "manualModeLabel": MessageLookupByLibrary.simpleMessage("Manuell"),
    ...
    "searchModeLabel": MessageLookupByLibrary.simpleMessage("Suche"),
    ...
    "targetDateHint": MessageLookupByLibrary.simpleMessage(
      "Wähle dein Zieldatum",
    ),
    "targetDateImpliedRate": m3,
    "targetDateLabel": MessageLookupByLibrary.simpleMessage("Zieldatum"),
    "targetDateSelectedLabel": m4,
    "targetDateSkipLabel": MessageLookupByLibrary.simpleMessage("Überspringen"),
    ...
    "targetDateValidationPast": MessageLookupByLibrary.simpleMessage(
      "Das Zieldatum muss in der Zukunft liegen",
    ),
    "targetDateValidationTooSoon": MessageLookupByLibrary.simpleMessage(
      "Plane mindestens 2 Wochen für einen gesunden Plan ein",
    ),
